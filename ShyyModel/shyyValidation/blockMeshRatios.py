...
cellsYDielectric = 20   # Cells y-axis thickness of deielectric
cellsYGrounded = 10     # Cells y-axis thickness of grounded electrode
cellsYExposed = 15       # Cells y-axis thickness of exposed electrode

cellsYTop = 70          # Cells y-axis exposed up to "Top" boundary
cellsYBottom = 50       # Cells y-axis grounded down to "Bottom" boundary

cellsXGap = 15          # Cells x-axis gap (min dx=L/cellsXGap)
cellsXExposed = 5      # Cells x-axis exposed electrode
CellsXGrounded = 55     # Cells x-axis grounded electrode
cellsXRHS = 50          # Cells x-axis RHS of grounded
cellsXLHS = 10          # Cells x-axis LHS of exposed
